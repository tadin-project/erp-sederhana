...
<head>
  ...
  <title>ERP System - SuperAdmin</title>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown" id="navOrder">
            ...
            <ul class="dropdown-menu">
              ...
              <li id="topNavProductionQuantity"><a href="tsukamoto.php?o=prodqnty"> <i class="glyphicon glyphicon-stats"></i> Production Quantity</a>
              </li>
            </ul>
          </li>
